...
var Home = /*#__PURE__*/function (_PureComponent) {
  ...
  function Home() {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "update_stations", function () {
      ...
      /// const subset_param_data = (this.state.selectedVariables)
      ///                     ? param_data.filter((item) => item['ParameterGroups'].filter((subitem) => return subitem['Parameter']['Name'] == this.state.selectedVariables ? subitem['Parameter']['Id'] : 'nothing' ))
      ///                     : param_data
      /// console.log(subset_param_data)
      /// stations supplying data with those parameters (for filtering stations)
      /// const new_stations_data = subset_param_data.filter((item => return))
      /// this.setState({})
...
//# sourceMappingURL=index.js.a906267425f906ea1745.hot-update.js.map