...
var Home = /*#__PURE__*/function (_PureComponent) {
  ...
  function Home() {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "setGroupName", function (e) {
      ...
      _this.setState({
        selectedGroupNames: e[0].variable
      }, function () {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "update_stations", function () {
      var param_data = _this.state.parameter_data;
      var new_data = _this.state.selectedGroupNames ? _this.state.all_stations_data.filter(function (item) {
        return item['Code'].startsWith(_this.state.selectedGroupNames);
      }) : _this.state.all_stations_data; ///  const new_data = (this.state.selectedVariables)
      ///                      ?
      ///                      : new_data
      ...
      var subset_param_data = _this.state.selectedVariables ? param_data.filter(function (item) {
        return item['ParameterGroups'].some(function (subitem) {
          return subitem['Parameter']['Name'] == _this.state.selectedVariables;
        });
      }) : param_data; /// stations supplying data with those parameters (for filtering stations)

      var new_stations_data = subset_param_data.filter(function (item) {
        return item['Id'];
      });
      console.log(new_stations_data); /// this.setState({})
    });
...
//# sourceMappingURL=index.js.15d7c895b41996750d1d.hot-update.js.map