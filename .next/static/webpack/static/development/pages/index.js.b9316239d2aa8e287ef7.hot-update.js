...
var Home = /*#__PURE__*/function (_PureComponent) {
  ...
  function Home() {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "update_stations", function () {
      ...
      var subset_param_data = _this.state.selectedVariables.length != null ? param_data.filter(function (item) {
        return item['ParameterGroups'].some(function (subitem) {
          return subitem['Parameter']['Name'] == _this.state.selectedVariables;
        });
      }) : param_data;
      var new_data = _this.state.selectedGroupNames.length != null ? _this.state.all_stations_data.filter(function (item) {
...
//# sourceMappingURL=index.js.b9316239d2aa8e287ef7.hot-update.js.map